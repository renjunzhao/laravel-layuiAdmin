...
<head>
    ...
    <link rel="stylesheet" href="{{url('src/layuiadmin/style/login.css')}}" media="all">
</head>
<body>
...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    ...
    <div class="layui-trans layadmin-user-login-footer">
        ...
        <p>© 2018 <a href="#" target="_blank">Demo</a></p>
        <p>
            <span><a href="#" target="_blank">Demo</a></span>
            <span><a href="#" target="_blank">Demo</a></span>
            <span><a href="#" target="_blank">Demo</a></span>
        </p>
    </div>
                ...
                data: obj.field,
                    ...
                    if (res.data.code == 1001) {
                        ...
                        layer.msg('登入成功', {
                            ...
                            location.href = 'index?token=' + res.data.token; //后台主页
                        });
