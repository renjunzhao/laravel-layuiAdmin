...
CREATE TABLE `menus`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 52 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `permissions`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '权限' ROW_FORMAT = Dynamic;
...
-- Records of roles
-- ----------------------------
INSERT INTO `roles` VALUES (5, '超级管理员', 'admin', '2019-11-19 16:25:25', '2019-12-11 10:28:36');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, '$2y$10$XkA7Ty4WGY5ZbRn1oEF6H.Gvevn7USV7ibq4UNuF1heE6QWbPUuYm', '18888888888', 'https://wx4.sinaimg.cn/mw1024/5db11ff4gy1fmx4keaw9pj20dw08caa4.jpg', '2147483647121', 1, '123456@qq.com', 'China', '86', NULL, '卡洛斯1', '2019-11-16 11:41:45', '2019-11-18 10:38:54');
