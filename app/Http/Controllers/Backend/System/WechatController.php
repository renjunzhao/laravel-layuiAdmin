...
class WechatController extends Controller
{
    ...
    public function index()
    {
        ...
        $system = $setting['data'][0]['wechat'];
        $id = $setting['data'][0]['id'];
        return view('backend.system.wechat',compact('token','user','system','id'));
    }
    ...
    {
        $this->repository->update(['wechat' => $request->except('token','_token','id')],$id);
